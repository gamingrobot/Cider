...
def get_modules():
    from . import CiderUtils, CiderMeshes, CiderProperties, CiderPipeline, CiderRenderer
    return [ CiderUtils, CiderMeshes, CiderProperties, CiderPipeline, CiderRenderer ]
