...
def get_modules():
    from . import CiderUtils, CiderMeshes, CiderProperties, CiderPipeline, CiderMaterial, CiderRenderer
    return [ CiderUtils, CiderMeshes, CiderProperties, CiderPipeline, CiderMaterial, CiderRenderer ]
